...
{
    [HtmlTargetElement("*", Attributes = "suppress-by-avaliacao2")]
    public class ApagaElementoByAvaliacao2TagHelper : TagHelper
    {
        private readonly IComiteService _comiteService;
        private readonly IActionContextAccessor _actionContextAccessor;
        private readonly UserManager<AppUser> _userManager;

        public ApagaElementoByAvaliacao2TagHelper(IComiteService comiteService,
        ...
        [HtmlAttributeName("suppress-by-avaliacao2")]
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (model.Ideia.StatusId == StatusEnum.EmAnalise2.ToInt())
            {
                ...
                var analises = comiteIdeiasResultList
                    .Where(p => p.AspNetUsersId == uid && p.IdeiaId == IdeiaId && p.SequenciaAnalise == 2);
